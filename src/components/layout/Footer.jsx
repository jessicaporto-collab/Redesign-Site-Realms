...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-950 text-gray-400">
      <Container>
        {/* Main grid */}
        <div className="py-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 border-b border-gray-800">
          {/* Brand column */}
          <div className="lg:col-span-2">
            <Link to="/" className="inline-flex mb-5">
              <img src={logoRealmsWhite} alt="Realms" className="h-10 w-auto" />
            </Link>
          ...
          {/* Products column */}
          <div>
            <h4 className="font-semibold text-white text-sm mb-4">{t('footer.products')}</h4>
        ...
        <div className="py-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-500">
          <p>
            © {year} Vocaciona. {t('footer.rights')}
          </p>
