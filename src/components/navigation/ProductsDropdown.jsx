...
const PRODUCTS = [
  ...
  { key: 'iptv',     path: '/iptv-conteudo',          icon: '●', accent: 'text-rose-400',   bg: 'bg-rose-500/10' },
  { key: 'conteudo', path: '/conteudo-educacional',    icon: '◑', accent: 'text-amber-400',  bg: 'bg-amber-500/10' },
]
