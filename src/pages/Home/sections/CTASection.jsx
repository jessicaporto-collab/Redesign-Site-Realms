      ...
      <section id="cta" className="bg-[#080808] py-24 lg:py-36 relative overflow-hidden">
        ...
        <Container>
          <div ref={ctaRef} className="text-center max-w-3xl mx-auto">
            ...
            {/* Social icons */}
            <div className="reveal delay-4 flex items-center justify-center gap-4">
              {SOCIAL_LINKS.map((s) => (
                <a
                  key={s.label}
                  href={s.href}
                  aria-label={s.label}
                  className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/35 hover:text-white hover:border-white/25 transition-all duration-200 min-w-[40px]"
                >
