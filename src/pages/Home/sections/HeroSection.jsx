...
const SOCIAL_LINKS = [
  {
    label: 'LinkedIn',
    href: 'https://br.linkedin.com/company/realms-education',
    icon: (
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/realms.education/',
    icon: (
  ...
  {
    label: 'YouTube',
    href: 'https://www.youtube.com/@realms.education',
    icon: (
  ...
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/people/Realms-Web-3/100091590892436/',
    icon: (
...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="absolute inset-0 bg-gradient-to-r from-black/90 via-black/70 to-black/30"
        aria-hidden="true"
      />
      <div
        className="absolute inset-0 bg-gradient-to-t from-[#0a0a0a]/85 via-transparent to-transparent"
        aria-hidden="true"
      />
